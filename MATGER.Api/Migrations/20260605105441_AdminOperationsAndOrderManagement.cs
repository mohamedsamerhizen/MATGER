...
{
    /// <inheritdoc />
    public partial class AdminOperationsAndOrderManagement : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MinimumOrderSubtotal = table.Column<decimal>(type: "decimal(18,2)", precision: 18, scale: 2, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Floor = table.Column<string>(type: "nvarchar(80)", maxLength: 80, nullable: true),
                    Apartment = table.Column<string>(type: "nvarchar(80)", maxLength: 80, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CouponCodeSnapshot = table.Column<string>(type: "nvarchar(64)", maxLength: 64, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ShippingCarrier = table.Column<string>(type: "nvarchar(120)", maxLength: 120, nullable: true),
                    ...
                    ShippingFullName = table.Column<string>(type: "nvarchar(150)", maxLength: 150, nullable: true),
                    ShippingPhoneNumber = table.Column<string>(type: "nvarchar(40)", maxLength: 40, nullable: true),
                    ...
                    ShippingArea = table.Column<string>(type: "nvarchar(120)", maxLength: 120, nullable: true),
                    ShippingStreet = table.Column<string>(type: "nvarchar(200)", maxLength: 200, nullable: true),
                    ShippingBuilding = table.Column<string>(type: "nvarchar(80)", maxLength: 80, nullable: true),
                    ShippingFloor = table.Column<string>(type: "nvarchar(80)", maxLength: 80, nullable: true),
                    ShippingApartment = table.Column<string>(type: "nvarchar(80)", maxLength: 80, nullable: true),
                    ShippingPostalCode = table.Column<string>(type: "nvarchar(40)", maxLength: 40, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CodeSnapshot = table.Column<string>(type: "nvarchar(64)", maxLength: 64, nullable: false),
                    DiscountAmount = table.Column<decimal>(type: "decimal(18,2)", precision: 18, scale: 2, nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false)
                },
                constraints: table =>
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_OrderInternalNotes_AspNetUsers_AuthorUserId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Status = table.Column<int>(type: "int", nullable: false),
                    ProviderReference = table.Column<string>(type: "nvarchar(120)", maxLength: 120, nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                    ConfirmedAt = table.Column<DateTime>(type: "datetime2", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ProductReviews_AspNetUsers_HiddenByUserId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    QuantityAvailableBefore = table.Column<int>(type: "int", nullable: false),
                    QuantityAvailableAfter = table.Column<int>(type: "int", nullable: false),
                    ...
                    Reason = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: true),
                    ReferenceType = table.Column<string>(type: "nvarchar(120)", maxLength: 120, nullable: true),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_OrderInternalNotes_AuthorUserId",
                table: "OrderInternalNotes",
                column: "AuthorUserId");

            migrationBuilder.CreateIndex(
                name: "IX_OrderInternalNotes_CreatedAt",
                table: "OrderInternalNotes",
                column: "CreatedAt");

            migrationBuilder.CreateIndex(
                name: "IX_OrderInternalNotes_OrderId",
                table: "OrderInternalNotes",
                column: "OrderId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ProductReviews_HiddenByUserId",
                table: "ProductReviews",
